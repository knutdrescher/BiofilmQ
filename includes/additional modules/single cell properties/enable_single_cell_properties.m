...
cellParametersCalculate =...
    ...
    'Fit an ellipse into each object to calculate eigenvectors and object dimensions. Then calculate the aspect ratio (longest axis/smallest axis and intermediate axis/smallest axis) of each object.', ...
    'usage/parameter_calculation.html';...
    ...
    'Quantify the wall-to-wall distance for each object. Random points are selected on the surface of each object and the perpendicular distances to the next surfaces are calculated.', ...
    ...
    'Calculate the vertical alignment, the alignment with the radial vector pointing to the center of the biofilm and the alignment with the direction of the external flow as well as the local nematic order around each cell.', ...
